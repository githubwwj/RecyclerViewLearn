...
public class TuiJianAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private final List<HomeBean.DataBean.TuijianBean> dataList;
    private final Context context;
    private LayoutInflater layoutInflater;

    public TuiJianAdapter(List<HomeBean.DataBean.TuijianBean> dataList, Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            HomeBean.DataBean.TuijianBean tuijianBean = dataList.get(position);
